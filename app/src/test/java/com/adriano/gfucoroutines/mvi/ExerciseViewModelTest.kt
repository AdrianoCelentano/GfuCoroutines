...
class ExerciseViewModelTest {
    ...
    @Test
    fun `handleCalculateData updates simpleState Loading then Success`() =
        runTest { // TODO 4: Übergib `testDispatcher` an `runTest(...)`
    ...
    @Test
    fun `handleFetchUser with valid ID emits Loading then Success`() =
        runTest { // TODO 12: Übergib `testDispatcher`
    ...
    @Test
    fun `handleFetchUser with invalid ID emits Loading then Error`() =
        runTest { // TODO 16: Übergib `testDispatcher`
